...
const AboutMe = () => {
  ...
  // ));
  return (
    <div className='row about-me px-2 px-md-0'>
      <div className='col-0 col-md-2' />
      <div className='col-12 col-md-8 d-flex align-items-center shadow-lg main flex-column flex-lg-row py-2'>
        <div className='px-4 py-4 py-lg-0'>
          <h2 className='h2 title pb-3'>About me</h2>
          <p className='about-me-text'>
            I am currently a software engineer at{' '}
            <a
              className='link'
            ...
            . Also, I am a computer engineering junior at the German University in Cairo.
            A fencer for the first-team at Gezira Sporting Club.
          </p>
        </div>
        <img src={selfImage} alt='about-me illustration' />
      </div>
      <div className='col-0 col-md-2' />
    </div>
  );
